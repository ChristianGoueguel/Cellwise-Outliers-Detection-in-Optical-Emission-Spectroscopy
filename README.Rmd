...
The best way to compare the two methods is to plot their respective cellMap.
A cellmap is a powerful display of cells that are unusual. More specifically, unusually large cell values are colored in red whilst unusually low cell values are colored in blue. Moreover, a large number of unusual cells values on a single row will tend to contaminate the entire row making the observation an outlier.
